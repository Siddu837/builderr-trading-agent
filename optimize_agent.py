...
def main():
    ...
    for i in range(attempts):
        ...
        try:
            ...
            # Compute average Calmar and check if any limits were breached
            ...
            if passed and avg_calmar > best_avg_calmar:
                best_avg_calmar = avg_calmar
                best_params = params
                best_results = results
                print(f"New best: {best_avg_calmar:.4f} (combination {i+1}/{attempts})")
